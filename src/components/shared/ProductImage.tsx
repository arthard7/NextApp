...
export const ProductImage = ({className, alt, src, size}: ProductImageProps) => {

    return (
        <div className={cn('relative items-center justify-center flex w-[500px] min-w-[490px]', className)}>
